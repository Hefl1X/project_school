...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setGeometry(400, 300, 700, 500)  # Устанавливаем размеры окна
        
        # Создаём главный виджет, который будет в центральным в окне
        main_widget = QWidget()
        ...
        stats_layout.addWidget(QLabel(f"Устройства в использовании: {100}"))
        stats_layout.addWidget(QLabel(f"Списанные устройства: {20}"))
        ...
        # 4. Таблица с добавленными устройствами
        ...
        version_label = QLabel("Версия Beta 1.0")
